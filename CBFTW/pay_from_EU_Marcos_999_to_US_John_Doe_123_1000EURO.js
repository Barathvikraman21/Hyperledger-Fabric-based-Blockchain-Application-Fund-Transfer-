...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
        ...
        // pay chaincode function - requires 3 args ex: args['US_John_Doe_123', 
        // 'UK_Alice_456', '1000']
        ...
        var request = {
                ...
                */
                fcn: 'pay',
                args: ['EU_Marcos_999', 'US_John_doe_123', '1000'],
        ...
        if (isProposalGood) {
                ...
                let txPromise = new Promise((resolve, reject) => {
                        let handle = setTimeout(() => {
                                ...
                                resolve({event_status : 'TIMEOUT'}); //we could use reject
                                // (new Error('Trnasaction did not complete within 30 seconds'));
                        }, 3000);
                        event_hub.connect();
